...
namespace Evo.Services.Cryptography
{
    ...
    //For the Keccak Algoirthm implemented in this solution, l was choosen to be 6.  
    // value of l = {0, 1, 2, 3, 4, 5, 6}
    // // b = 25 x 2ˡ ; b = state size
    // Since l was choosen to be 6, the state size based upon the 
    // formula below is set to 1600 bits.  Higher the state size 
    // better the security it provides.
